...
export default function Navbar() {
  ...
  return (
    <div className='bg-[black] w-[100%] pl-[30px] pr-[30px] pt-[20px] pb-[20px] flex justify-between sticky top-0 items-center'>
        <p className='text-[white] font-[Poppins] font-[900] flex gap-[0.8px] items-center'>fair.dev<span className='code'>|</span></p>
        ...
        <button className='bg-[none] border-[2px] border-[#388bfd] rounded-lg text-[#388bfd] w-[auto] h-[50px] font-[Poppins] font-[700] p-3 flex items-center gap-2 hover:border-[#1b2a41]'><FaGithub size={25}/>Github Profile</button>
